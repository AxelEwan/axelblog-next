...
export default defineAppConfig({
	...
	footer: {
		...
		iconNav: [
			...
			{ icon: 'tabler:brand-instagram', text: 'IG@axelewan_', url: 'https://www.instagram.com/axelewan_' },
			{ icon: 'tabler:brand-github', text: 'GitHub: AxelEwan', url: 'https://github.com/AxelEwan' },
		...
		nav: [
			...
			},
			{
				title: '社交',
				items: [
					{ icon: 'tabler:brand-github', text: 'AxelEwan', url: 'https://github.com/AxelEwan' },
					{ icon: 'tabler:brand-instagram', text: 'axelewan_', url: 'https://www.instagram.com/axelewan_' },
			...
			},
			{
				...
				items: [
					...
					{ icon: 'tabler:certificate', text: 'XICP备2026号', url: 'https://beian.miit.gov.cn/' },
				],
			},
		] satisfies Nav,
	},
